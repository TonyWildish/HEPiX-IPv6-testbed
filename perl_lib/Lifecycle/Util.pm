...
sub SetProductMap {
    my ( $t, $k );
    undef %Lifecycle::System::Product::Map;

    foreach $t ( keys %{ $Lifecycle::System{ProductMap} } ) {
        foreach $k ( keys %{ $Lifecycle::System{ProductMap}{$t} } ) {
            foreach ( @{ $Lifecycle::System{ProductMap}{$t}{$k} } ) {
                $Lifecycle::System::Product::Map{$t}{$k}{$_}++;
            }
        }
    }
}
...
sub IsRequiredProduct {
    ...
    return 1 unless defined $Lifecycle::System::Product::Map{$type};
    return 1 unless defined $Lifecycle::System::Product::Map{$type}{$input};
    return 1 if defined $Lifecycle::System::Product::Map{$type}{$input}{$output};
    return 0;
}
...
sub IsRequiredSource {
    ...
    return 1 unless defined $Lifecycle::System::Product::Map{$type};
    return 1 if defined $Lifecycle::System::Product::Map{$type}{$input};
    return 0;
}
