...
Lifecycle::Core::Config::Agent - Manage Agent startup parameters

=head1 SYNOPSIS

This module is used by L<Lifecycle::Core::Config|Lifecycle::Core::Config> to manage
...
Lifecycle::Core::Config::Agent object allows you to set and retrieve these
...
L<Lifecycle::Core::Config|Lifecycle::Core::Config> object and passed to the Agent
constructor.
