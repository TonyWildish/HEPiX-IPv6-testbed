...
Lifecycle::Core::Config::Environment - Manage Agent environment configuration parameters

=head1 SYNOPSIS

This module is used by L<Lifecycle::Core::Config|Lifecycle::Core::Config> to expand
...
Lifecycle::Core::Config::Environment objects are created and used by the
L<Lifecycle::Core::Config|Lifecycle::Core::Config> module. They allow an agent or
...
L<Lifecycle::Core::Config|Lifecycle::Core::Config> object that creates them to set
...
=item CONFIG( \$Lifecycle::Core::Config )
