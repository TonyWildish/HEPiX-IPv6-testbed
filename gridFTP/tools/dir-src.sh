...
echo dir /grid/home/ipv6wg/wildish/src | uberftp fgintosg1.fnal.gov | grep ipv6
...
echo ' '
echo imperial
echo dir /srv/localstage/ipv6test/wildish/src | uberftp hepix01.grid.hep.ph.ic.ac.uk
...
echo ' '
echo ndgf
echo dir /ipv6/wildish/src | uberftp bunsen.ndgf.org | grep ipv6
