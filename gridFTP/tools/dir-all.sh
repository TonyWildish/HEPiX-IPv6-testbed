...
echo ' '
echo fnal
echo /grid/home/ipvgwg/wildish
echo dir /grid/home/ipv6wg/wildish | uberftp fgintosg1.fnal.gov | grep ipv6
...
#echo ' '
#echo imperial
#echo dir /srv/localstage/ipv6test/wildish | uberftp hepix01.grid.hep.ph.ic.ac.uk | grep ipv6test

echo ' '
echo ' '
echo ndgf
echo dir /ipv6/wildish | uberftp bunsen.ndgf.org | grep ipv6
